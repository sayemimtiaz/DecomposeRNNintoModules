...
# rnn_model.add(GRU(nb_units,return_sequences=True, reset_after=False))
# rnn_model.add(GRU(nb_units,return_sequences=True, reset_after=False))
# rnn_model.add(GRU(nb_units,return_sequences=True, reset_after=False))
rnn_model.add(GRU(nb_units,return_sequences=False, reset_after=False))
...
rnn_model.save('h5/model1_combined.h5')
