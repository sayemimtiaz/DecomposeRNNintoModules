...
from gru_models.many_to_many_different.many_to_many_different_unrolled.evaluator_unrolled import \
    evaluate_unrolled
...
for j in labs:
    ...
    for source, target in positive_data:
        ...
        for layerNo, _layer in enumerate(positiveConcern):
            if _layer.type == LayerType.GRU and ConcernIdentificationEnDe.is_decoder_layer(_layer):
