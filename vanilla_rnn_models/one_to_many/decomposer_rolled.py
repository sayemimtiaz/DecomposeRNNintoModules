...
from vanilla_rnn_models.one_to_many.evaluator_rolled import evaluate_rolled
from relu_models.one_to_many.one_to_many_util import load_toxic_dataset_combine_math_qa, load_toxic_dataset
...
if 'combined' in model_name:
    x_train, x_test, y_train, y_test, num_words, timestep, nb_classes = \
        load_toxic_dataset_combine_math_qa(repeat=False, hot_encode=False)
else:
    x_train, x_test, y_train, y_test, num_words, timestep, nb_classes = \
