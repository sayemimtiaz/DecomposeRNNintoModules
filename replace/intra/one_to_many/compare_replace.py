...
bestModelName = 'model3'
faultyModelName = 'model1'
base_path = os.path.dirname(os.path.realpath(__file__))
base_path = os.path.dirname(os.path.dirname(os.path.dirname(base_path)))
faulty_module_path = os.path.join(base_path, activation, 'one_to_many', 'modules', faultyModelName)
...
out = open(os.path.join(base_path, 'replace', 'intra', 'one_to_many',"resul_"+activation+".csv"), "w")
out.write('Replaced Class,Modularized Accuracy\n')

faulty_model_path = os.path.join(base_path, activation, 'one_to_many', 'h5', faultyModelName + '.h5')
