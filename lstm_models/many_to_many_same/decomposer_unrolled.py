...
from lstm_models.many_to_many_same.evaluator_unrolled import evaluate_unrolled
        ...
        for layerNo, _layer in enumerate(positiveConcern):
            if shouldRemove(_layer):
                if _layer.type == LayerType.LSTM:
                    ...
                    # tangleConcernBasedOnComparison(positiveConcern[layerNo],
                    #                                         negativeConcern[layerNo])
