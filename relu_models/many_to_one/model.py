...
from keras.layers import Dense, Embedding, TimeDistributed, Dropout, SimpleRNN
...
rnn_model.add(SimpleRNN(nb_units,return_sequences=True, activation='relu'))
rnn_model.add(SimpleRNN(nb_units,return_sequences=True, activation='relu'))
rnn_model.add(SimpleRNN(nb_units,return_sequences=True, activation='relu'))
rnn_model.add(SimpleRNN(nb_units,return_sequences=False, activation='relu'))
