...
from motivating_example.problem1.solution1.evaluator_rolled import evaulate_rolled
...
model_name = os.path.join(root, 'h5', 'solution1.h5')

model = load_model(model_name)
concernIdentifier = ConcernIdentificationEnDe()

train_ds, val_ds, test_pairs, \
source_vectorization, target_vectorization, target_languages = load_problem1_solution1_data(sequence_length=20, just_pairs=True)
