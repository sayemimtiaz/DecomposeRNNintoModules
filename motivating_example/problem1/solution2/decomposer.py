...
from motivating_example.problem1.solution2.evaluator_rolled_solution2 import evaulate_rolled
...
model_name = os.path.join(root, 'h5', 'solution2.h5')

model = load_model(model_name)
concernIdentifier = ConcernIdentificationEnDe()

train_ds, val_ds, test_pairs, \
source_vectorization, target_vectorization, target_languages = load_problem1_solution2_data(sequence_length=20, just_pairs=True)
