from motivating_example.problem2.solution1.evaluator_rolled_solution1 import evaulate_rolled
...
from motivating_example.problem2.problem2_data_util import load_problem2_solution1_data
...
model_name = 'h5/solution1_problem2.h5'

model = load_model(model_name)
concernIdentifier = ConcernIdentificationEnDe()

train_ds, val_ds, test_pairs, \
source_vectorization, target_vectorization, target_languages = load_problem2_solution1_data(sequence_length=20, just_pairs=True, vocab_size=2000)
