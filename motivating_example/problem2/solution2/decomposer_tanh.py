from motivating_example.problem2.solution2.evaluator_rolled_solution2 import evaulate_rolled
...
from motivating_example.problem2.problem2_data_util import load_problem2_solution2_data
...
model_name = 'h5/solution2_problem2.h5'

model = load_model(model_name)
concernIdentifier = ConcernIdentificationEnDe()

train_ds, val_ds, test_pairs, \
source_vectorization, target_vectorization, target_languages = load_problem2_solution2_data(sequence_length=20, just_pairs=True)
